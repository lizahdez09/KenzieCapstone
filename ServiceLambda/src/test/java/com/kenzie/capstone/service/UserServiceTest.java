...
//        String password = "password";
//        String email = "email";
//        String favoriteRecipes = "favoriteRecipesList";
//
//        UserRecord userRecord = new UserRecord();
//        userRecord.setId(id);
//        userRecord.setName(name);
...
//        userRecord.setEmail(email);
//
//        when(userDao.createNewUser(Mockito.anyString(), name, password, email, favoriteRecipes)).thenReturn(userRecord);
//
//        // Act
//        User user = userService.setUserData(id, name, password, email, favoriteRecipes);
//
//        // Assert
//        Assertions.assertEquals(id, user.getId());
//        Assertions.assertEquals(name, user.getName());
